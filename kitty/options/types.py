...
choices_for_default_pointer_shape = typing.Literal[
    'arrow',
    'beam',
    'text',
    'pointer',
...
class Options:
    ...
    bold_font: FontSpec = FontSpec(
        family=None, style=None, postscript_name=None, full_name=None, system='auto', axes=(), variable_name=None, features=(), created_from_string='auto'
    )
    bold_italic_font: FontSpec = FontSpec(
        family=None, style=None, postscript_name=None, full_name=None, system='auto', axes=(), variable_name=None, features=(), created_from_string='auto'
    )
    ...
    cursor_blink_interval: tuple[float, kitty.options.utils.EasingFunction, kitty.options.utils.EasingFunction] = (
        -1.0,
        kitty.options.utils.EasingFunction(),
        kitty.options.utils.EasingFunction(),
    )
    cursor_shape: int = 1
    ...
    mouse_hide_wait: MouseHideWait = (
        MouseHideWait(hide_wait=0.0, show_wait=0.0, show_threshold=40, scroll_show=True)
        if is_macos
        else MouseHideWait(hide_wait=3.0, show_wait=0.0, show_threshold=40, scroll_show=True)
    )
    ...
    visual_bell_duration: tuple[float, kitty.options.utils.EasingFunction, kitty.options.utils.EasingFunction] = (
        0.0,
        kitty.options.utils.EasingFunction(),
        kitty.options.utils.EasingFunction(),
    )
...
defaults.map = [
    # copy_to_clipboard
    KeyDefinition(
        trigger=SingleKey(mods=256, key=99),
        options=KeyMapOptions(
            ...
            on_action='keep',
            timeout=None,
            allow_fallback=(KeyFallbackType.shifted, KeyFallbackType.alternate),
        ),
        definition='copy_to_clipboard',
    ),
    # paste_from_clipboard
    KeyDefinition(
        trigger=SingleKey(mods=256, key=118),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
        ...
        definition='paste_from_clipboard',
    ),
    # paste_from_selection
    KeyDefinition(
        trigger=SingleKey(mods=256, key=115),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
    ...
    KeyDefinition(
        ...
        definition='scroll_line_down smooth',
    ),
    # scroll_page_up
    ...
    KeyDefinition(
        trigger=SingleKey(mods=256, key=122),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
    ...
    # show_scrollback
    KeyDefinition(
        trigger=SingleKey(mods=256, key=104),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
        ...
        definition='show_scrollback',
    ),
    # show_last_command_output
    KeyDefinition(
        trigger=SingleKey(mods=256, key=103),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
        ...
        definition='show_last_command_output',
    ),
    # search_scrollback
    ...
    # new_os_window
    KeyDefinition(
        trigger=SingleKey(mods=256, key=110),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
        ...
        definition='new_os_window',
    ),
    # close_window
    KeyDefinition(
        trigger=SingleKey(mods=256, key=119),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
    ...
    # move_window_forward
    KeyDefinition(
        trigger=SingleKey(mods=256, key=102),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
        ...
        definition='move_window_forward',
    ),
    # move_window_backward
    KeyDefinition(
        trigger=SingleKey(mods=256, key=98),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
    ...
    KeyDefinition(
        ...
        definition='start_resizing_window',
    ),
    # first_window
    ...
    # new_tab
    KeyDefinition(
        trigger=SingleKey(mods=256, key=116),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
    ...
    # close_tab
    KeyDefinition(
        trigger=SingleKey(mods=256, key=113),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
    ...
    # set_tab_title
    KeyDefinition(
        trigger=SingleKey(mods=258, key=116),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
        ...
        definition='set_tab_title',
    ),
    # next_layout
    KeyDefinition(
        trigger=SingleKey(mods=256, key=108),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
    ...
    # open_url
    KeyDefinition(
        trigger=SingleKey(mods=256, key=101),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
        ...
        definition='open_url_with_hints',
    ),
    # insert_selected_path
    KeyDefinition(
        is_sequence=True,
        trigger=SingleKey(mods=256, key=112),
        rest=(SingleKey(key=102),),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
        ...
        definition='kitten hints --type path --program -',
    ),
    # open_selected_path
    KeyDefinition(
        is_sequence=True,
        trigger=SingleKey(mods=256, key=112),
        rest=(SingleKey(mods=1, key=102),),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
        ...
        definition='kitten hints --type path',
    ),
    # insert_chosen_file
    KeyDefinition(
        is_sequence=True,
        trigger=SingleKey(mods=256, key=112),
        rest=(SingleKey(key=99),),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
        ...
        definition='kitten choose-files',
    ),
    # insert_chosen_directory
    KeyDefinition(
        is_sequence=True,
        trigger=SingleKey(mods=256, key=112),
        rest=(SingleKey(key=100),),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
        ...
        definition='kitten choose-files --mode=dir',
    ),
    # insert_selected_line
    KeyDefinition(
        is_sequence=True,
        trigger=SingleKey(mods=256, key=112),
        rest=(SingleKey(key=108),),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
        ...
        definition='kitten hints --type line --program -',
    ),
    # insert_selected_word
    KeyDefinition(
        is_sequence=True,
        trigger=SingleKey(mods=256, key=112),
        rest=(SingleKey(key=119),),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
        ...
        definition='kitten hints --type word --program -',
    ),
    # insert_selected_hash
    KeyDefinition(
        is_sequence=True,
        trigger=SingleKey(mods=256, key=112),
        rest=(SingleKey(key=104),),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
        ...
        definition='kitten hints --type hash --program -',
    ),
    # goto_file_line
    KeyDefinition(
        is_sequence=True,
        trigger=SingleKey(mods=256, key=112),
        rest=(SingleKey(key=110),),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
        ...
        definition='kitten hints --type linenum',
    ),
    # open_selected_hyperlink
    KeyDefinition(
        is_sequence=True,
        trigger=SingleKey(mods=256, key=112),
        rest=(SingleKey(key=121),),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
        ...
        definition='kitten hints --type hyperlink',
    ),
    # show_kitty_doc
    ...
    KeyDefinition(
        trigger=SingleKey(mods=256, key=117),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
        ...
        definition='kitten unicode_input',
    ),
    # edit_config_file
    ...
    KeyDefinition(
        is_sequence=True,
        trigger=SingleKey(mods=256, key=97),
        rest=(SingleKey(key=109),),
        options=KeyMapOptions(
            when_focus_on='',
            new_mode='',
            mode='',
        ...
        definition='set_background_opacity +0.1',
    ),
    ...
    KeyDefinition(
        ...
        definition='set_background_opacity 1',
    ),
    ...
    KeyDefinition(
        ...
        definition='set_background_opacity default',
    ),
    # reset_terminal
...
if is_macos:
    defaults.map.append(
        KeyDefinition(
            trigger=SingleKey(mods=8, key=99),
            options=KeyMapOptions(
                when_focus_on='',
                new_mode='',
                mode='',
            ...
            definition='copy_or_noop',
        )
    )
    defaults.map.append(
        KeyDefinition(
            trigger=SingleKey(mods=8, key=118),
            options=KeyMapOptions(
                when_focus_on='',
                new_mode='',
                mode='',
    ...
    defaults.map.append(
        KeyDefinition(
            trigger=SingleKey(mods=8, key=102),
            options=KeyMapOptions(
                when_focus_on='',
                new_mode='',
                mode='',
    ...
    defaults.map.append(
        KeyDefinition(
            trigger=SingleKey(mods=9, key=100),
            options=KeyMapOptions(
                when_focus_on='',
                new_mode='',
                mode='',
    ...
    defaults.map.append(
        KeyDefinition(
            trigger=SingleKey(mods=8, key=114),
            options=KeyMapOptions(
                when_focus_on='',
                new_mode='',
                mode='',
    ...
    defaults.map.append(
        KeyDefinition(
            trigger=SingleKey(mods=8, key=116),
            options=KeyMapOptions(
                when_focus_on='',
                new_mode='',
                mode='',
    ...
    defaults.map.append(
        KeyDefinition(
            trigger=SingleKey(mods=8, key=119),
            options=KeyMapOptions(
                when_focus_on='',
                new_mode='',
                mode='',
    ...
    defaults.map.append(
        KeyDefinition(
            trigger=SingleKey(mods=9, key=119),
            options=KeyMapOptions(
                when_focus_on='',
                new_mode='',
                mode='',
            ...
            definition='close_os_window',
        )
    )
    defaults.map.append(
        KeyDefinition(
            trigger=SingleKey(mods=9, key=105),
            options=KeyMapOptions(
                when_focus_on='',
                new_mode='',
                mode='',
    ...
    defaults.map.append(
        KeyDefinition(
            trigger=SingleKey(mods=12, key=102),
            options=KeyMapOptions(
                when_focus_on='',
                new_mode='',
                mode='',
            ...
            definition='toggle_fullscreen',
        )
    )
    defaults.map.append(
        KeyDefinition(
            trigger=SingleKey(mods=10, key=115),
            options=KeyMapOptions(
                when_focus_on='',
                new_mode='',
                mode='',
            ...
            definition='toggle_macos_secure_keyboard_entry',
        )
    )
...
special_colors = frozenset({'scrollbar_handle_color', 'scrollbar_track_color', 'wayland_titlebar_color', 'macos_titlebar_color'})
